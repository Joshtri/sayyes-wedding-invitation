...
const GroomSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f6f0e4] text-gray-800 px-4 py-8">
      ...
      {/* Groom Image and Info */}
      <div className="flex flex-col items-center">
        <div className="relative">
          <div className="absolute -left-20 top-1/2 transform -translate-y-1/2 rotate-90 text-gray-700 text-lg font-serif">
            THE GROOM
          </div>
          <img
        ...
        {/* Groom Name and Details */}
        <h3 className="text-2xl font-great-vibes mb-1">Andy Hartono</h3>
